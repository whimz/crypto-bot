...
const FIELDS = [
  ...
  },
  {
    ...
    step: 0.01,
    isFraction: true,
    what: "Процент роста цены от средней цены входа, при котором бот форсированно продаёт всю позицию — независимо от RSI/EMA-сигнала",
    optimal: "2-5% — частая фиксация небольшой прибыли. 0% — отключено, поведение как раньше",
    risk: "слишком низкое (<1%) — продаст почти сразу после покупки, не дав позиции вырасти. Слишком высокое (10%+) — мало отличается от ожидания обычного SELL-сигнала",
  },
  {
